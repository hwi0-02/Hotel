...
public class ReservationDtos {
    ...
    public static class DashboardActivityResponse {
        ...
        public List<OwnerReservationResponse> getCheckIns() {
            return copy(checkIns);
        }

        public void setCheckIns(List<OwnerReservationResponse> checkIns) {
            this.checkIns = copy(checkIns);
        }

        public List<OwnerReservationResponse> getCheckOuts() {
            return copy(checkOuts);
        }

        public void setCheckOuts(List<OwnerReservationResponse> checkOuts) {
            this.checkOuts = copy(checkOuts);
        }

        public List<OwnerReservationResponse> getRecentReservations() {
            return copy(recentReservations);
        }

        public void setRecentReservations(List<OwnerReservationResponse> recentReservations) {
            this.recentReservations = copy(recentReservations);
        }
