...
public class AdminDashboardController {
    ...
    long totalCoupons = couponRepository.count();
        long totalInquiries = websiteInquiryRepository.count();
    ...
    DashboardDto dto = DashboardDto.builder()
        ...
        .pendingInquiries(websiteInquiryRepository.countByStatus("PENDING"))
    ...
    stats.put("totalInquiries", websiteInquiryRepository.count());
        stats.put("pendingInquiries", websiteInquiryRepository.countByStatus("PENDING"));
