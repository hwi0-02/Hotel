...
public class ReservationCalendarDayDto {
    ...
    @Builder
    private ReservationCalendarDayDto(LocalDate date,
                                      int totalReservations,
                                      int confirmedReservations,
                                      int pendingReservations,
                                      int cancelledReservations,
    ...
    public List<ReservationSummary> getReservations() {
        return reservations == null ? List.of() : new ArrayList<>(reservations);
    }
    ...
    return ReservationCalendarDayDto.builder()
        ...
        .reservations(reservationSummaries == null ? List.of() : List.copyOf(reservationSummaries))
        .build();
    }
}
