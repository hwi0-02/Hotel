...
public class User {
    ...
    @Enumerated(EnumType.STRING)
    @Column(name = "login_lock_type")
    private LoginLockType loginLockType;
    ...
    public void setLoginLockType(LoginLockType loginLockType) { this.loginLockType = loginLockType; }
    public void setLoginLockUntil(LocalDateTime loginLockUntil) { this.loginLockUntil = loginLockUntil; }
}
