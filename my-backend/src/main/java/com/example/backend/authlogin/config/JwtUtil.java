...
public class JwtUtil {
    ...
    public String generateToken(User user) {
        return generateToken(user.getId(), user.getEmail(), user.getName(), user.getProvider());
    }

    public String generateToken(Long userId, String email, String name, User.Provider provider) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("userId", userId);
        claims.put("email", email);
        claims.put("name", name);
        claims.put("provider", provider != null ? provider.toString() : null);
